...
public class MaramHoeItem extends DirtylavatModElements.ModElement {
	@ObjectHolder("dirtylavat:maram_hoe")
	public static final Item block = null;

	public MaramHoeItem(DirtylavatModElements instance) {
		super(instance, 5);
	}
