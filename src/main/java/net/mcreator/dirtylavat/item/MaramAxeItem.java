...
public class MaramAxeItem extends DirtylavatModElements.ModElement {
	@ObjectHolder("dirtylavat:maram_axe")
	public static final Item block = null;

	public MaramAxeItem(DirtylavatModElements instance) {
		super(instance, 2);
	}
